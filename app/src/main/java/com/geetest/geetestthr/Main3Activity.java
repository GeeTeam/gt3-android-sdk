...
//                map_st = result;
//                GtApi1json gtApi1json = new GtApi1json();
//                gtApi1json.execute();
                Log.i("Timessss", "数据统计:" + result.toString());
            }
            ...
            public void gt3DialogOnError(String error) {
                Log.i("Timesss", "ssssccsssssssssscc" );
...
//             captcha.SubmitStatisticsJson(map_st);
