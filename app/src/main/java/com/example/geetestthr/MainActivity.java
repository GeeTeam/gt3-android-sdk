...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        bu_go = (Button) findViewById(R.id.bu_go);
        bu_go.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                Gt3GeetestTestMsg.setCandotouch(false);//这里设置验证成功后是否可以关闭
            ...
            //如果为true这边的的完成走gt3DialogSuccessResult，同时需要完成gt3GetDialogResult里面的二次验证，验证完毕记得关闭dialog,调用gt3GeetestUtils.gt3TestFinish();
            @Override
